...
class AdditionalItemsBooleanKeywordDigester(
  ...
  override fun extractKeyword(jsonObject: JsonValueWithPath, builder: MutableSchema, schemaLoader: SchemaLoader, report: LoadingReport): KeywordDigest<ItemsKeyword>? {

...
fun SchemaAssert.isReadOnly(): SchemaAssert {
  assert(actual.draft7().isReadOnly, "readOnly").all {
    isNotNull()
    isTrue()
  }
  return this
...
fun SchemaAssert.isWriteOnly(): SchemaAssert {
  assert(actual.draft7().isWriteOnly, "writeOnly").all {
    isNotNull()
    isTrue()
  }
  return this
